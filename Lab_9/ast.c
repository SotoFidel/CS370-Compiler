    ...
    */
    ...
    /*
        Date: April 13, 2020
        ADDED FUNCTIONALITY FOR SYMBOL TABLE
            *Created a function that checks the formal parameters of a fundec and
             the actual parameters of a function call, that will throw an error
             if either the length of the parameters don't match , or if the type doesn't match.
             *Added some more functionality to the print statement that will print out the 
...
int checkFormalsAndParms(ASTNode *f, ASTNode *a)
{
    ...
    if (f->semanticType != a->semanticType)
    {
        return 0;
    }
    ...
    switch (p->Type)
    {
        ...
        //Variable declaration    
            ...
            */
            ...
            if (p->symbol != NULL) printf(" -- Has offset: %d -- Level: %d",p->symbol->offset, p->symbol->level);
        ...
        //function declaration
            ...
            /*
                ...
                of parameters.
            */
            printf("%s -- Level: %d -- Offset: NA \n", p->name, p->symbol->level);
            printTabs(level);
            printf("(\n");
            if (p->s1 != NULL)
            {
        ...
        case variable:
            ...
            else 
            {
                ...
                printTabs(level + 1);
                printf("NAME: %s -- Has Offset: %d -- Level: %d\n", p->name, p->symbol->offset, p->symbol->level);
                printTabs(level + 1);
                printf("[\n");
